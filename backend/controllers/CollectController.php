...
class CollectController extends  \yii\base\Controller
{
    public function actionCollect()
    {
        $dp = opendir("/Erp/webRoot/backend/controllers");
...
//                var_dump($temp);
                ...
                \YII::$app->db->createCommand()->batchInsert("{{%controller_method}}", ["name", "controller_class_id"], $temp)->execute();
            }
        }
    }
